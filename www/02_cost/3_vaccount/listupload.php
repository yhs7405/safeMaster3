...
//	$e_upload_date		=	trim($_REQUEST[e_upload_date]);
	...
	$excel_file = trim($_REQUEST[excel_file]);
...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom">비용관련</a> <a href="#" class="current">가상계좌/수납</a> <a href="#" class="current">수납내역업로드</a> </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
     ...
     <form name="ff" action="listupload_ok.php" method="post" class="form-horizontal" onsubmit="return f_submit();" enctype="multipart/form-data">
      ...
      <div class="span6" style="width:98%;"  style="text-align:center;">
        <div class="widget-box"  style="text-align:center;">
          <div class="widget-content nopadding"  style="text-align:center;">
			...
			<tr>
				<td>파일</td>
				<td><input type=file name=excel_file value="<?=$excel_file?>"></td>
			</tr>
			<tr>
...
<?if($_SESSION["admin_permission"][ch_d52]=="y"){?>
