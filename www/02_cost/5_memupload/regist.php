  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span6" style="width:98%;">
		...
		<tr>
			<td>* 소속</td>
			<td><input type="text" class="span11" name="sosok" id="sosok"  placeholder="소속"  maxlength=50   value="<?=$row[sosok]?>"/></td>
			<td>* 주소</td>
		...
		<table  style="width:98%;max-width:700px;margin:10px;border:1px solid gray;" border=1>
		<tr  bgcolor="#c0c0c0">
			<td width="30%" align=center>대분류</td>
			<td width="40%" align=center>조회 / 등록</td>
		</tr>
		<tr bgcolor="#cfcfcf">
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 전입세대열람조회</td>
			<td align=center><input type=checkbox name=ch_111 <?if(($pm[ch_111]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_112 <?if(($pm[ch_112]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 전입세대열람등록</td>
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 고객지원팀조회</td>
			<td align=center><input type=checkbox name=ch_211 <?if(($pm[ch_211]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_212 <?if(($pm[ch_212]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 기본상세조회(팝업)</td>
			<td align=center><input type=checkbox name=ch_221 <?if(($pm[ch_221]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_222 <?if(($pm[ch_222]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 필증수령입력(이전)</td>
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 데이터삭제</td>
			<td align=center><input type=checkbox name=ch_331 <?if(($pm[ch_331]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_332 <?if(($pm[ch_332]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>

		<tr bgcolor="#cfcfcf">
			<td style="font-weight:900">&nbsp;&nbsp;&nbsp;사건부</td>
			<td align=center><input type=checkbox name=ch_400 <?if(($pm[ch_400]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 사건부</td>
			<td align=center><input type=checkbox name=ch_411 <?if(($pm[ch_411]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_412 <?if(($pm[ch_412]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 이전양식출력</td>
			<td align=center><input type=checkbox name=ch_511 <?if(($pm[ch_511]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_512 <?if(($pm[ch_512]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 설정양식출력</td>
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 환불금조회</td>
			<td align=center><input type=checkbox name=ch_711 <?if(($pm[ch_711]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_712 <?if(($pm[ch_712]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 환불계좌조회</td>
		...
		<tr bgcolor="#cfcfcf">
			<td style="font-weight:900">&nbsp;&nbsp;&nbsp;ERP기장</td>
			<td align=center><input type=checkbox name=ch_800 <?if(($pm[ch_800]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ ERP기장</td>
			<td align=center><input type=checkbox name=ch_811 <?if(($pm[ch_811]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_812 <?if(($pm[ch_812]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 정산보고서조회</td>
			<td align=center><input type=checkbox name=ch_931 <?if(($pm[ch_931]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_932 <?if(($pm[ch_932]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 현장상세정보</td>
		...
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 계정목록</td>
			<td align=center><input type=checkbox name=ch_a11 <?if(($pm[ch_a11]=="y")||($mode=="i")){?>checked<?}?> value="y"> / <input type=checkbox  name=ch_a12 <?if(($pm[ch_a12]=="y")||($mode=="i")){?>checked<?}?> value="y"></td>
		</tr>
		<tr>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 계정등록</td>
