        ...
        <div class="widget-box">
          <div class="widget-content nopadding">
            ...
            <div class="widget-content nopadding">
							...
							<tr>
								<td width="5%">&nbsp;&nbsp;&nbsp;* 현장</td>
							<td width="15%" colspan=3><select name="h_idx" id="h_idx" <?if($mode=="e"){?>   <? } ?> style="width:300px;>
								...
								<td width="5%">&nbsp;&nbsp;&nbsp;* 은행</td>
								<td width="15%"><select name="bank_code" id="bank_code"  onchange="javascript:select_detail_all('bank_code','jijum_code');" <?if($mode=="e"){?>   <? } ?> >
								...
								<td width="5%">&nbsp;&nbsp;&nbsp;* 지점</td>
								<td width="15%"><select name="jijum_code" id="jijum_code" style="width:300px;" <?if($mode=="e"){?>   <? } ?> >
								...
								<td width="5%">&nbsp;&nbsp;&nbsp;* 구분</td>
								<td width=150px><select name="gubun_code" id="gubun_code" style="width:100px;">
