<?	include ("../../include/dbconn.php");
	...
	$wherequery = " WHERE bank_code='{$bank_code}' and gubun_code='{$gubun_code}' and basic_gukto='basic' ";
	...
	$wherequery = " WHERE bank_code='{$bank_code}' and gubun_code='{$gubun_code}' and basic_gukto='gukto' ";
	$sql= "select * from $board_dbname ".$wherequery;
	//echo $sql;
