...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb" style="text-align:center;"><h3>설정필증리스트</h3></div>
  </div>
  ...
  <div class="container-fluid">
            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="background-color:#70AD47;color:white;">필증정산일</th>
                  <th style="background-color:#70AD47;color:white;">필증배포일</th>
                </tr>
              </thead>
              <tbody>
	...
	$sql = "select i.h_idx,i.g1,i.g1,i.e1,i.h1,i.i1,i.j1,i.m1,i.aw1,s.sjp_s_date,s.sjp_j_date,s.sjj_w_date,s.sjp_b_date,s.bank_code,s.jijum_code from tbl_junib i cross join tbl_suljung s on i.a1=s.a1  $wherequery order by   cast(i.h1 as unsigned) asc,cast(i.i1 as unsigned) asc limit $Page_link[start],$view_num";
	//echo $sql;
		...
		$T = 1;
			while($row = $stmt->fetch()){?>
                ...
                <tr class="odd gradeX">
                  ...
                  <td style="text-align:center;"><?=$row[aw1]?></td>
                  <td style="text-align:center;"><?=f_date($row[sjp_s_date])?></td>
                  <td style="text-align:center;"><?=f_date($row[sjp_j_date])?></td>
                  <td style="text-align:center;"><?=f_date($row[sjj_w_date])?></td>
                  <td style="text-align:center;"><?=f_date($row[sjp_b_date])?></td>
...
function f_form_print(){
	...
	if($("#s_date").val()==""){
		...
		var url    ="/report_form/popup_form_b/index.html";
		var title  = "listpop11";
