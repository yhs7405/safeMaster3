<?	include ("../include/dbconn.php");
	...
	$sql = "select b.bank_code,b.bank_name from tbl_bank_jijum_rate a , tbl_bank_info b where a.bank_code=b.bank_code and a.h_idx = '{$h_idx}' group by b.bank_code  order by b.bank_code,b.bank_name asc";
