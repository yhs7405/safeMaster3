...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom">데이터관리</a> <a href="#" class="current">데이타삭제</a> </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
     ...
     <form name="ff" action="data_delete_ok.php" method="post" class="form-horizontal" onsubmit="return f_submit();" enctype="multipart/form-data">
...
<?if($_SESSION["admin_id"]=="master"){?>
			<div style="text-align:center;" >
				<span id="filex"><button type="submit" class="btn btn-success">데이타 삭제하기</button></span>
			</div>
<?}?>
...
function f_submit(){
	var v = document.ff;
	if(confirm("엑셀로 모든 데이타를 다운로드 받으셨습니까?\n정말로 삭제하시겠습니까?\n")){
		$("#filex").html("<b style='color:blue;'>데이타 삭제중...</b>");
		return true;
	}
}
