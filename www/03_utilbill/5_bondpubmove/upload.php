...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom">공과금산정납부</a> <a href="#" class="current">채권발행(이전채권)</a> <a href="#" class="current">채권발행(이전채권) 후 업로드</a> </div>
  </div>
        ...
        <div class="widget-box"  style="text-align:center;">
          <div class="widget-content nopadding"  style="text-align:center;">
			...
			<div style="text-align:right;">
				...
				<span id="filedn"><a href="./(채권)이전채권발급후입력용.xls" download><button type="button" class="btn btn-success" style="background-color:#F29661;">양식다운로드</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</div>
...
<?if($_SESSION["admin_permission"][ch_e62]=="y"){?>
