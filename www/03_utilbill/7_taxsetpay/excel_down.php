  ...
  // 설정갯수
	...
	$objPHPExcel->getActiveSheet()->getColumnDimension('AF')->setWidth(15);
     ...
     $objPHPExcel->setActiveSheetIndex(0)
                 ...
                 ->setCellValue("G".$i, "채최1")
                 ->setCellValue("H".$i, "채최2")
                 ->setCellValue("I".$i, "채최3")
                 ->setCellValue("J".$i, "채최4")
                 ->setCellValue("K".$i, "등록세1")
                 ->setCellValue("L".$i, "등록세2")
                 ->setCellValue("M".$i, "등록세3")
                 ->setCellValue("N".$i, "등록세4")
                 ->setCellValue("O".$i, "설정등록세1신고일")
                 ->setCellValue("P".$i, "설정등록세2신고일")
                 ->setCellValue("Q".$i, "설정등록세3신고일")
                 ->setCellValue("R".$i, "설정등록세4신고일")
                 ->setCellValue("S".$i, "설정등록세1수령일")
                 ->setCellValue("T".$i, "설정등록세2수령일")
                 ->setCellValue("U".$i, "설정등록세3수령일")
                 ->setCellValue("V".$i, "설정등록세4수령일")
                 ->setCellValue("W".$i, "설정등록세1납부일")
                 ->setCellValue("X".$i, "설정등록세2납부일")
                 ->setCellValue("Y".$i, "설정등록세3납부일")
                 ->setCellValue("Z".$i, "설정등록세4납부일")
                 ->setCellValue("AA".$i, "은행비고")
                 ->setCellValue("AB".$i, "정산비고")
                 ->setCellValue("AC".$i, "채최확인일1")
                 ->setCellValue("AD".$i, "채최확인일2")
                 ->setCellValue("AE".$i, "(예상)등기접수일")
                 ->setCellValue("AF".$i, "등기접수일")
                 ;
	$i++;
	...
	$i++;
	 ...
	 $objPHPExcel->setActiveSheetIndex(0); 
	 $filename = iconv("UTF-8", "EUC-KR", "설정등록세신고납부_엑셀");
