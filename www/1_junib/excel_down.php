<?	include ("../include/dbconn.php");
	...
	$sql = "select * from $board_dbname  $wherequery order by cast(h_idx as unsigned) asc,cast(b1 as unsigned) asc,cast(h1 as unsigned) asc,cast(i1 as unsigned) asc ";
	//echo $sql;
	...
	while($row = $stmt->fetch()){
     ...
     $objPHPExcel->setActiveSheetIndex(0)
                 ...
                 ->setCellValue("O".$i, f_date($row[memo]));
	$i++;
	}
